...
mod tests {
    ...
    fn test_parse_pipe_path_valid() {
        let (alias, bucket, key) = parse_pipe_path("minio/mybucket/file.txt").unwrap();
    ...
    fn test_parse_pipe_path_with_prefix() {
        let (alias, bucket, key) = parse_pipe_path("minio/mybucket/path/to/file.txt").unwrap();
        assert_eq!(alias, "minio");
        assert_eq!(bucket, "mybucket");
    ...
    fn test_parse_pipe_path_no_key() {
        assert!(parse_pipe_path("minio/mybucket").is_err());
    }
